<?php
    ...
    $id = $_GET['v'];
    $selec = "SELECT * FROM as_teacher WHERE teacher_id='$id'";
    ...
    <form action="">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card_header_title"><i class="fab fa-gg-circle"></i>View Teacher Data</h4>
                    </div>
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered table-hover table-striped custom_view_table">
                                ...
                                <tr>
                                    <td>Designation</td>
                                    <td class="dot">:</td>
                                    <td><?= $info['teacher_designation']; ?></td>
                                </tr>
                                <tr>
                                    <td>Details</td>
                                    <td class="dot">:</td>
