        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover custom_table">
                    ...
                    $i = 1;
                    $search = $_GET['search'];
                    $sel = "SELECT * FROM as_user NATURAL JOIN as_role WHERE user_name LIKE '%$search%' || user_email LIKE '%$search%' || user_phone LIKE '%$search%' || user_role LIKE '%$search%' || user_username LIKE '%$search%'";
